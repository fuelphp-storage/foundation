			...
			<div class="stack-container">
				...
				<div class="frames-container cf <?php echo (!$v->hasFrames ? 'empty' : '') ?>">
					...
					<div class="frame <?php echo ($i == 0 ? 'active' : '') ?>" id="frame-line-<?php echo $i ?>">
						...
						<span class="frame-file">
							<?php echo ($frame->getFile(true) ?: '<#unknown>') ?><span class="frame-line"><?php echo (int) $frame->getLine() ?></span>
						</span>
					</div>
					<?php endforeach ?>
				...
				<div class="details-container cf">
					...
					* we get 200 frames to process. */ ?>
					...
					<?php /* Remove some entries from $v->tables, the Handler doesn't let us */
					unset ($v->tables['Server/Request Data']);
					unset ($v->tables['POST Data']);
					unset ($v->tables['GET Data']);
					unset ($v->tables['Session']);
					unset ($v->tables['Cookies']);
					?>
